Industry project developed in collaboration with Amdocs.
...
Neural network facial recognition algorithm written with Python and PyTorch for a dataset of 5,700 people. Algorithm deployed as a REST API with Java and Spring Framework.
