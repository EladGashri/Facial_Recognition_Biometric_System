...
public class EmployeeService {
    ...
    public List<EmployeeDto> getEmployeesListByNameWithRegex(String name, Integer limit){
        try{
    ...
    public boolean verifyEmployee(long id, long number){
        return employeesRepository.getEmployeeName(id,number)!=null;
    }
