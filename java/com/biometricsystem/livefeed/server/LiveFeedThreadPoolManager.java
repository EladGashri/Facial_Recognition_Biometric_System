...
public class LiveFeedThreadPoolManager {
    private final int ANALYZER_NUMBER_OF_THREADS=5;
    private final int REGISTER_NUMBER_OF_THREADS=5;
    private final int QUEUE_MANAGER_NUMBER_OF_THREADS=1;
    private final int THREAD_POOL_SIZE=ANALYZER_NUMBER_OF_THREADS+REGISTER_NUMBER_OF_THREADS+QUEUE_MANAGER_NUMBER_OF_THREADS;
