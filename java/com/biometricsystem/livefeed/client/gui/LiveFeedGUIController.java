...
public class LiveFeedGUIController {
    ...
    public void setIdentificationComponents(byte[] frameAsByteArray,String probability){
        String title="Face did not pass threshold with "+probability+" probability. Please Enter ID and employee number in order to identify.";
        view.setTitle(title);
        view.setPanelIcon(new ImageIcon(frameAsByteArray));
