    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.
            csrf().
                disable().
            authorizeRequests().
                antMatchers("/model/training").hasAnyAuthority(EmployeeType.CTO.getAuthority()).
                antMatchers("/employees/*","/attendances/*","/branch-employees","/model/identification").hasAnyAuthority(EmployeeType.ADMIN.getAuthority(),EmployeeType.CTO.getAuthority()).
