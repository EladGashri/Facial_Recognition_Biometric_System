...
public class EmployeeDto{
    ...
    public EmployeeDto(long id, long employeeNumber, String name, String branch, Integer employeeType, int numberOfImages, int modelClass, double modelAccuracy, boolean includedInModel) {
        this.id=id;
