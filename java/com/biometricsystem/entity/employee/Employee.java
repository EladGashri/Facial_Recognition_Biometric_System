...
public class Employee{
    ...
    public Employee(long id, long employeeNumber, String name, String branch, int employeeType, int numberOfImages,Integer modelClass,String imagesDirectoryPath, boolean includedInModel) {
        this.id = id;
    ...
    public Employee(long id, long employeeNumber){
        this(id,employeeNumber,null,null,EmployeeType.UNDEFINED.getDatabaseValue(),0,null,null,false);
    }
